...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { name: 'aurora-header-aurora', url: '/api/header?name=Maya+Chen&title=ML+Engineer&tagline=Chasing+signal+in+the+noise&metal=aurora&style=aurora&height=260', type: 'header' },
      { name: 'matrix-header-neon-green', url: '/api/header?name=NEO&title=Systems+Architect&metal=neon-green&style=matrix&height=260', type: 'header' },
      { name: 'wave-flow-header-electric', url: '/api/header?name=Sam+Rivera&title=Frontend+Engineer&tagline=React+%C2%B7+Motion+%C2%B7+Design&metal=electric&style=wave-flow&height=260', type: 'header' },
      { name: 'particles-header-neon-blue', url: '/api/header?name=STARDUST&title=Data+Scientist&metal=neon-blue&style=particles&height=220', type: 'header' },
      { name: 'neon-grid-header-neon-pink', url: '/api/header?name=SYNTHWAVE&title=Game+Developer&metal=neon-pink&style=neon-grid&height=260', type: 'header' },
      { name: 'liquid-metal-header-chrome', url: '/api/header?name=Jordan+Lee&title=Platform+Engineer&tagline=Fluid+infrastructure+at+scale&metal=chrome&style=liquid-metal&height=260', type: 'header' },
      { name: 'orbit-header-electric', url: '/api/header?name=Ava+Kim&title=Cloud+Architect&tagline=Always+in+orbit%2C+never+offline&metal=electric&style=orbit&height=260', type: 'header' },
      { name: 'gradient-mesh-header-aurora', url: '/api/header?name=Leo+Park&title=Product+Engineer&tagline=Design+meets+code&metal=aurora&style=gradient-mesh&height=260', type: 'header' },
      { name: 'glass-header-rose-gold', url: '/api/header?name=Nina+Osei&title=UX+Engineer&tagline=Clarity+through+simplicity&metal=rose-gold&style=glass&height=260', type: 'header' },
      { name: 'split-header-electric', url: '/api/header?name=Priya+Nair&title=Solutions+Architect&tagline=Design+%C2%B7+Build+%C2%B7+Scale&metal=electric&style=split&height=260', type: 'header' },
      { name: 'constellation-header-neon-blue', url: '/api/header?name=STARBOUND&title=Astrophysics+%C2%B7+Data&metal=neon-blue&style=constellation&height=240', type: 'header' },
      { name: 'circuit-board-header-gold', url: '/api/header?name=Circuit+Dev&title=Embedded+Systems+Engineer&metal=gold&style=circuit-board&height=260', type: 'header' },
      { name: 'skyline-header-sunset', url: '/api/header?name=Metro+Dev&title=Full-Stack+Engineer&metal=gold&style=skyline&height=260', type: 'header' },
      { name: 'blueprint-header-electric', url: '/api/header?name=Design+Spec&title=Systems+Engineer&tagline=Precision+by+design&metal=electric&style=blueprint&height=260', type: 'header' },
      { name: 'geometric-header-aurora', url: '/api/header?name=Aria+Wolfe&title=Product+Designer&metal=aurora&style=geometric&height=240', type: 'header' },
      { name: 'signal-wave-header-neon-pink', url: '/api/header?name=DJ+Byte&title=Audio+%C2%B7+Creative+Coder&metal=neon-pink&style=signal-wave&height=240', type: 'header' },
      { name: 'ribbon-header-rose-gold', url: '/api/header?name=Elena+Cruz&title=Brand+%C2%B7+Web+Designer&tagline=Elegant+by+design&metal=rose-gold&style=ribbon&height=260', type: 'header' },
