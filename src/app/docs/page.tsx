                    ...
                    <Section id="components" tag="// 06" title="All Components">
                        <div className="space-y-4">
                            {[
                                ...
                                { name: 'Header', route: '/api/header', desc: '22 styles including flowing, animated backgrounds: profile, minimal, cyber, terminal, hologram, aurora, matrix, wave-flow, particles, neon-grid, liquid-metal, orbit, gradient-mesh, glass, split, constellation, circuit-board, skyline, blueprint, geometric, signal-wave, ribbon.', key_params: 'name, title, tagline, avatar, style (22 options), animated, speed, particles' },
