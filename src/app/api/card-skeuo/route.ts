// src/app/api/card-skeuo/route.ts
// ─────────────────────────────────────────────────────────────────────────────
import { NextRequest, NextResponse } from 'next/server'
import { renderSkeuoCard, SkeuoTheme, SkeuoStyle, Dimension } from '@/lib/renderers/card-skeuo'
...
export async function GET(req: NextRequest) {
    ...
    const skeuoTheme = (p.get('skeuoTheme') ?? p.get('theme') ?? 'brushedMetal') as SkeuoTheme
    ...
    try {
        ...
        const svg = renderSkeuoCard({
            title, value, subtitle, icon,
            skeuoTheme,
            style: (p.get('style') ?? 'card') as SkeuoStyle,
